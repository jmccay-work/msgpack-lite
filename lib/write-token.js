...
const IS_BUFFER_SHIM = Bufferish.hasBuffer && ("TYPED_ARRAY_SUPPORT" in Buffer);
const NO_TYPED_ARRAY = IS_BUFFER_SHIM && !Buffer.TYPED_ARRAY_SUPPORT;
let Buffer_prototype = Bufferish.hasBuffer && Buffer.prototype || {};
...
function writeN(type, len, method, noAssert) {
  return function(encoder, value) {
    let offset = encoder.reserve(len + 1);
